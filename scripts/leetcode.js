...
const upload = (token, hook, code, problem, filename, sha, commitMsg, cb = undefined) => {
  const URL = `https://api.github.com/repos/${hook}/contents/src/com/company/leetcode/${problem}/${filename}`;
...
async function getUpdatedData(token, hook, directory, filename) {
  const URL = `https://api.github.com/repos/${hook}/contents/src/com/company/leetcode/${directory}/${filename}`;
